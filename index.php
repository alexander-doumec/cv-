...
<html lang="en">
    ...
    <header class="bg-success text-white text-center py-4">
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <img src="Assets/Picture/phot.jpg" alt="Photo de Doumec Alexander" class="img-fluid rounded-circle mb-3">
                </div>
                <div class="col-md-8">
    ...
    <main class="container my-5">
        <section id="informations" class="mb-5">
            ...
            <ul class="list-unstyled">
                ...
                <li><strong>GitHub:</strong> <a href="https://github.com/alexander-doumec" target="_blank">alexander-doumec</a></li>
        ...
        <section id="formations" class="mb-5">
            ...
            <!-- Ajoutez d'autres formations de la même manière -->
        </section>
